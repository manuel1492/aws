...
// main.js
const smsWelcome = () => { return `🌟 *¡Bienvenido(a) al grupo @subject!* 🌈\n\n👋 ¡Hola @user!\n📄 *Lee la descripción del grupo* para estar al tanto de las normas y novedades.\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '👋 ¡Hasta luego @user! 😎 *Nos vemos en otra ocasión.* 🌟'}
const smsSpromote = () => { return '*¡@user ahora es un administrador del grupo! 🌟*'}
const smsSdemote = () => { return '*@user ya no es administrador del grupo. 😔*'}
const smsSdesc = () => { return '*La nueva descripción del grupo es:*\n\n@desc'}
const smsSsubject = () => { return '*¡Nuevo nombre del grupo!*\n\n@subject'}
const smsSicon = () => { return '*¡Se ha cambiado la foto del grupo! 📸*'}
const smsSrevoke = () => { return '*¡Ahora el enlace del grupo es privado!*\n\n*@revoke para obtener el nuevo enlace.*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'Manubot @robledojuan10 '} 
...
const smsLisA = () => { return '_*Estás en estos grupos:*_'}
...
//ad
const smsMalused = () => { return '⚡ *Usa el comando de esta forma:*\n'}
const smsMalused2 = () => { return `${lenguajeGB['smsAvisoMG']()}🐈 *Debes usar el comando como en este ejemplo:*\n`}
const smsMalused3 = () => { return `${lenguajeGB['smsAvisoMG']()}🐈 *Debes usar el comando o responder al mensaje de alguien como en este ejemplo:*\n`}
...
const smsGrupoTime7 = () => { return '🔒 *El grupo está cerrado, solo admins pueden enviar mensajes*'}
const smsGrupoTime8 = () => { return '🔓 *El grupo está abierto, todos pueden enviar mensajes*'}
...
const smsGrupoTime12 = () => { return 'Permitir que el grupo se abra por '}
const smsGrupoTime13 = () => { return 'Permitir que el grupo se cierre por '}

//grupo-add.js
const smsAddB1 = () => { return `${lenguajeGB['smsAvisoFG']()}*No se puede agregar el número, verifica que sea correcto o agrégalo manualmente.*`}
const smsAddB2 = () => { return `${lenguajeGB['smsAvisoFG']()}*No se puede agregar el número, verifica que sea correcto o agrégalo manualmente.*`}
...
const smsAdveu1 = () => { return `${lenguajeGB['smsAvisoAG']()}*Solo puedes usar esto si está activada la función:*\n`}
const smsAdveu2 = () => { return 'Motivo'}
const smsAdveu3 = () => { return `${lenguajeGB['smsAvisoMG']()}*Recuerda escribir el motivo de la advertencia*\n`}
const smsAdveu4 = () => { return '*Recibiste una advertencia en este grupo!!*'}
const smsAdveu5 = () => { return 'Advertencia'}
const smsAdveu6 = () => { return '🎒 Inventario'} 
const smsAdveu7 = () => { return '*Te lo advertí varias veces!!*'}
const smsAdveu8 = () => { return '*Ahora serás eliminado(a)* 🙄'}
const smsAdveu9 = () => { return '😇 Muchas gracias'}
const smsAdveu10 = () => { return '*Se te eliminó una advertencia en este grupo!!*'}
const smsAdveu11 = () => { return 'Antes:'}
const smsAdveu12 = () => { return 'Ahora:'}

//grupo-demote.js || grupo-promote.js 
const smsDemott = () => { return '*El número no es válido. Vuelve a intentar respondiendo al mensaje de alguien o usa como en este ejemplo:*\n'}
...
const smsGI10 = () => { return '⚙️ Configuraciones del grupo'}

//grupo-kick.js
const smskick1 = () => { return `${lenguajeGB['smsAvisoAG']()}*Etiqueta a la persona o responde al mensaje de la persona que quieres eliminar*\n\n*Ejemplo: `}
...
//grupo-tagall.js
const smstagaa = () => { return `⚡ ¡Convocando a todo el grupo! ⚡`}

//grupo-setbye.js
const smsSetB = () => { return `${lenguajeGB['smsAvisoEG']()} 🚪 *La despedida del grupo ha sido configurada*`}
const smsSetB2 = () => { return `${lenguajeGB['smsAvisoIIG']()} 🙌 *_Escribe el mensaje de despedida_*\n*_Puedes usar "@" para agregar más información:_*\n\n*⚡ @user (Mención al usuario(a))*\n\n*Recuerda que el "@" es opcional*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeGB['smsAvisoEG']()} 🌟 *La bienvenida del grupo ha sido configurada*`}
const smsSetW2 = () => { return `${lenguajeGB['smsAvisoIIG']()} 🙌 *_Escribe el mensaje de bienvenida_*\n*_Puedes usar "@" para agregar más información:_*\n\n*⚡ @user (Mención al usuario(a))*\n*⚡ @subject (Nombre de grupo)*\n*⚡ @desc (Descripción de grupo)*\n\n*Recuerda que los "@" son opcionales*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeGB['smsAvisoEG']()} 📝 *La descripción del grupo ha sido configurada*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeGB['smsAvisoEG']()} 🏷️ *El nombre del grupo ha sido configurado*`}
const smsNam2 = () => { return `${lenguajeGB['smsAvisoMG']()} 🙌 *_Escribe el nuevo nombre del grupo_*`}
const smsNam3 = () => { return `${lenguajeGB['smsAvisoFG']()} ⚠️ *El nombre del grupo no debe tener más de 25 caracteres*`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: robledojuan602@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${lenguajeGB['smsAvisoAG']()} ⚠️ *UTILIZA ESTE COMANDO EN EL BOT PRINCIPAL*`}
const smsJBAdios = () => { return `${lenguajeGB['smsAvisoEG']()} 🥹 *TE VOY A EXTRAÑAR ${global.packname} ¡CHAO!*`}
const smsJBCerrarS = () => { return `${lenguajeGB['smsAvisoEG']()} 🚪 *HA CERRADO SESIÓN Y BORRADO TODO RASTRO*`}
const smsJBErr = () => { return `♻️ *HA CERRADO SESIÓN COMO SUB BOT*`} 

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeGB['smsAvisoAG']()} 🔞 *LOS COMANDOS ADULTOS ESTÁN DESACTIVADOS.* Si eres el creador(a), usa #on modohorny.`}

//comandos+18-menu.js
const smsList1 = () => { return `Oops, parece que no tienes suficientes 🌟`}
const smsList2 = () => { return `\nPresiona aquí para obtener más 💎`}
const smsList3 = () => { return `¡Contenido disponible! 😸`}
const smsList4 = () => { return `Contenido no disponible 😿\nPresiona aquí para obtener más 💎`}
const smsList5 = () => { return `*Selecciona una opción*\n*de la lista para ver el*\n*contenido* 😋`}
const smsList6 = () => { return `👀 VER LISTA 👀`}

//descargas-consejos.js
const smsConj = () => { return `🌟 ¡Nuevo Consejo del Día! 🍃` }
const smsFras = () => { return `🌈 ¡Nueva Frase Inspiradora! 🍃` }

//info-contacto.js
const smsContacto1 = () => { return '¡Hola! Soy ' + packname + ', un amigable asistente en WhatsApp 😎'}
const smsContacto2 = () => { return 'Soy el dueño de ' + packname + '. ¿Tienes alguna pregunta? Puedes decírmela aquí ✌️'}
const smsContacto3 = () => { return '👑 Dueño'}
const smsContacto4 = () => { return 'Cuenta oficial de Manubot'}
const smsContacto5 = () => { return '🐣 ¿Necesitas ayuda con algo?'}
const smsContacto6 = () => { return 'No tengo correo electrónico 🙏'}
const smsContacto7 = () => { return '🌎 Disponible en todo el mundo'}
const smsContacto8 = () => { return 'Esta cuenta es un asistente virtual 👀'}
