...
<p align="center">   
<a href="@leb.manuxs07/network/members"><img title="Forks" src="https://img.shields.io/github/forks/GataNina-Li/GataBot-MD?label=Forks&color=blue&style=flat-square"></a>
<a href="@leb.manuxs07/watchers"><img title="Watchers" src="https://img.shields.io/github/watchers/GataNina-Li/GataBot-MD?label=Watchers&color=green&style=flat-square"></a>
<a href="@leb.manuxs07/stargazers"><img title="Stars" src="https://img.shields.io/github/stars/GataNina-Li/GataBot-MD?label=Stars&color=yellow&style=flat-square"></a>
</p>
...
|------|-------------|-------|
| **TERMUX** | ***INSTALACIÓN AUTOMÁTICA*** |[ver](@leb.manuxs07/#-opción-1-instalación-automática-por-termux-) |
| **TERMUX** | ***INSTALACIÓN MANUAL*** |[ver](@leb.manuxs07/#-opción-2-instalación-manual-por-termux---github) |
| **TERMUX** | ***INSTALACIÓN POR ARCHIVOS*** |[ver](@leb.manuxs07/#-opción-3-instalación-por-termux---archivos) |
| **TERMUX 24/7** | ***COMANDOS*** |[ver](@leb.manuxs07/#-usar-GataBot-247-en-termux) |
| **TERMUX UPDATE** | ***COMANDOS PARA ACTUALIZAR GataBot*** |[ver](@leb.manuxs07/#-actualizar-GataBot) |
| **HEROKU** | ***INSTALACIÓN POR HEROKU*** |[ver](@leb.manuxs07/#-activar-en-heroku) |
| **BOXMINE** | ***INSTALACIÓN POR BOXMINE*** |[ver](@leb.manuxs07/#-boxminehost) |
| **REPLIT** | ***INSTALACIÓN POR REPLIT*** |[ver](@leb.manuxs07/#-replit---GataBot) |
| **KOYEB** | ***INSTALACIÓN POR KOYEB*** |[ver](@leb.manuxs07/#-activar-en-koyeb) |
| **WINDOWS** | ***INSTALACIÓN POR WINDOWS*** |[ver](@leb.manuxs07/#-para-usuarios-de-windowsvpsrdp) |
| **PREGUNTAS FRECUENTES** | ***DESPEJAR DUDAS*** |[ver](@leb.manuxs07/#-GataBot-md---preguntas) |
| **SOBRE GataBot** | ***SECCIONES DE INFORMACIÓN*** |[ver](@leb.manuxs07/#sobre-GataBot--gb-global) |
| **DESARROLLADORES** | ***PARTICIPATES DEL PROYECTO*** |[ver](@leb.manuxs07/#-creadora) |
-----
...
```
#### MODIFICAR ARCHIVO [`gata.sh`](@leb.manuxs07/blob/master/gata.sh)
```js
//LÍNEAS A MODIFICAR
205 --> "git clone https://github.com/[user]/[repositorio].git"
//Ejemplo: git clone @leb.manuxs07.git
...
### [`GataBot-MD ~ Archivos`](@leb.manuxs07/archive/refs/heads/master.zip)
...
```bash
git clone @leb.manuxs07 && cd GataBot-MD && npm install && npm update && node .
```
...
<summary><b>Configuración</b></summary>
  ...
  _Puede hacerlo desde [`💚 Aquí`](@leb.manuxs07/fork)._
  
  - [x] **¿Dónde puedo agregar el número del Bot?**<br>
  _Puede hacerlo desde el archivo [`⚙️ config.js`](@leb.manuxs07/blob/master/config.js). En el apartado `global.owner` puede agregar el número del Bot y más números como Owner._
  ```js
  global.owner = [
  ['59311222333', ' 💖🐈', true], // Número del Bot: Ejemplo +593 11 222 333
  ['59300999222'], // Owner 1 +593 00 999 222
  ['59377333999'] // Owner 2 +593 77 333 999
]
  ```
  - [x] **¿Cómo edito el texto del Bot?**<br>
  _Ir a la carpeta [`idiomas ✨`](@leb.manuxs07/tree/master/lib/idiomas) y selecciona el archivo del idioma que quiera modificar su contenido._
  
  - [x] **¿Dónde puedo cambiar el idioma de GataBot?**<br>
  _Puede cambiar el idioma ingresando [`Aquí`](@leb.manuxs07/blob/362ee2d694a033923efd9bf9ca16a2b0694e3073/config.js#L41)_
</details>
...
<summary><b>Preguntas sobre Termux</b></summary>
  ...
  _Puede usar la [`Instalación Automática 😼`](@leb.manuxs07/#-opci%C3%B3n-1-instalaci%C3%B3n-autom%C3%A1tica-por-termux-) si es la primera vez que va instalar._<br>
  ...
  _Desde la carpeta de GataBot use los comandos [`24/7 Termux 🚀`](@leb.manuxs07/#-usar-GataBot-247-en-termux)_
  ...
  _Desde la carpeta de GataBot usar los commandos para [`♻️ Actualizar GataBot-MD`](@leb.manuxs07/#-actualizar-GataBot)_
...
_Puede ver esa información [`Aquí 👈`](@leb.manuxs07/#-boxminehost)_
...
----
### 💠 [`IDIOMAS DISPONIBLES PARA GataBot`](@leb.manuxs07/blob/master/config.js) 
#### 🌐 Español  
#### 🌐 Inglés (English) 
#### 🌐 Portugués (Português)
...
### 🌟 DESARROLLADORES
<a href="@leb.manuxs07/graphs/contributors">
